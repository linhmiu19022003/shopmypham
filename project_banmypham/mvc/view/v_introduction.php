                ...
                <div class="col-10 col-md-10 p-0" style="border:1px solid rgb(235, 235, 235);">
                    ...
                    <div class="container mt-5" style="height: 500px;">
                        <div class="container px-4">
                            <h4 class="mt-5 text-uppercase">Giới thiệu</h4>
                            <div>
                                <span>Hồi kết cho bí quyết làm đẹp đã được hé lộ. Hãy cùng PINK điểm qua những mỹ phẩm
                                    Hàn Quốc trong danh sách hàng loạt sản phẩm đình đám nhé!</span>
                            </div>
                            <div class="my-3">
                                <span>Nếu bạn thường xuyên trang điểm mà không có nhiều thời gian để thực hiện quá nhiều
                                    thao tác tẩy trang thì sữa rửa mặt trứng là sự lựa chọn phù hợp cho da. Nổi bật với
                                    khả năng làm sạch được cả những lớp trang điểm dày, bụi bẩn và bã nhờn, sữa rửa mặt
                                    dòng trứng trắng sẽ giúp bạn tiết kiệm thời gian mà vẫn đảm bảo độ sạch cho
                                    da.</span>
                            </div>
                            <div class="mb-4">
                                <span>Tên đầy đủ cho loại má hồng dễ thương này là Too Cool For School Dinoplatz Cushy
                                    Blusher. Kết cấu má hồng rất dễ sử dụng, đầu bông của phấn má thay thế cọ trang điểm
                                    giúp bạn dễ dàng sử dụng được ngay trên da. Điểm nổi trội là Dinoplatz Cushy Blusher
                                    là có tone màu tự nhiên, thích hợp với những bạn còn đi học.</span>
                            </div>
                            <div>
                                <a class="rounded-5 py-3 px-4"
                                    style="text-decoration:none; background-color: #fc6e83; color: #fff;"
                                    href="tel:1900 6750">Đặt
                                    lịch ngay <i class="fa-solid fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
