...
.box2 .item_product_main:last-child {
    border-right: none;
}
            ...
            <div class="row main-bg">
                ...
                <div class="col-10 col-md-10 p-0" style="border:1px solid rgb(235, 235, 235);">
                    ...
                    <div class="container mt-5">
                        <div class="container">
                            <div class="product-chitiet d-flex">

                                <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-6" style="width:50%;">
                                    <div class="slider-for d1">
                                        <?php foreach ($brand as $key => $value) { ?>

                                        <div><img src="<?php echo $value['img_brand'] ?>" alt=""
                                    ...
                                    <div class="slider-nav d2">
                                        ...
                                        <div class="sp3"><img src="<?php echo $value['img_brand'] ?>" alt=""
                                                style="width: 100px; height: 85px;"></div>
                                        <?php } ?>
                                    </div>
                                </div>

                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 mota ">
                                    <h1 class="title-product "><?php echo $product[0]['name'] ?></h1>
                                    <div class="detail-pro ">
                                        <b>Loại:</b> <span><?php echo $product[0]['congdung'] ?></span>
                                        <b>Hãng:</b> <span><?php echo $product[0]['brand_name'] ?></span>
                                        <b>Tình trạng:</b> <span><?php echo $product[0]['trangthai'] ?></span>
                                    </div>
                                    <div class="price ">
                                        <span class="giasale"><?php echo number_format($product[0]['price']) ?>₫</span>
                                        <span class="giagoc"><?php echo $product[0]['cost'] ?></span>

                                        <p><i class="fa-solid fa-paper-plane "></i> Miễn phí vận chuyển đơn hàng từ
                                            800,000₫</p>
                                    </div>
                                    <div class="input-product ">
                                        ...
                                        <button class="add-giohang " type="button "><i class="fa-solid fa-gift "></i>
                                            <a
                                                href="?controller=c_add_to_cart&id_product=<?php echo $value['id_product'] ?>">Thêm
                                                vào giỏ hàng</a>
                                        </button>
                                    ...
                                    <div class="product-summary ">
                                        <h3>Mô tả</h3>
                                        <div class="detail-pro ">
                                            <b>Tồn kho:</b> <span><?php echo $product[0]['tonkho'] ?></span>
                                            <b>Xuất xứ:</b> <span><?php echo $product[0]['made'] ?></span>
                                            <b>Đã bán:</b> <span><?php echo $product[0]['daban'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="product-tab ">
                        <ul class="tab-mota d-flex ">
                            <li class="navtab-link ">
                                <h3 style="color: #fc6e83; ">MÔ TẢ CHI TIẾT</h3>
                            </li>
                            <li class="navtab-link ">
                                <h3 style="margin-left: 15px; ">&nbsp;/&nbsp; </h3>
                            </li>
                            <li class="navtab-link ">
                                <h3 style="margin-left: 15px; ">TAB TÙY CHỈNH</h3>
                            </li>
                        </ul>

                        <div class="product-text ">
                            <p style="text-align: justify; "><?php echo $product[0]['details'] ?></p>
                        </div>
                    </div>
                    ...
                    <!-- SẢN PHẨM LIÊN QUAN -->
                    <div class="swiper mySwiper" style="border-top: 1px solid #ebebeb ;">
                                        ...
                                        <form action="/cart/add" method="post" class="variants product-action"
                                            ...
                                            <div class="product-thumbnail clearfix">
                                                ...
                                                <div class="action">
                                                    ...
                                                    <a title="Xem nhanh" href="/sua-tam-victoria-s-secret-quyen-ru"
        ...
        <div class=container>
            <div class="row footer-bg">
                ...
                <div class="col-10 p-0">
                    <div class="all-footer-1" style="border: 1px solid #ebebeb; border-top: none; background: #f8f9fb;">
