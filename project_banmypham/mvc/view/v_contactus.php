                ...
                <div class="row hear-mn">
                    ...
                    <div class="col-10 col-md-10 col-sm-10 right-header">
                        ...
                        <div class="dc-wal">
                            ...
                            <a href="#" style="font-weight:500 ;">Địa chỉ: <span>118 Nguyen Khanh toan cau giay ha noi</span></a>
                        </div>
                        <div class="dkdn-wall">
                ...
                <div class="col-10 col-md-10 p-0" style="border:1px solid rgb(235, 235, 235);">
                    ...
                    <div class="container">
                        <div class="container px-4">
                            ...
                            <ul class="d-flex p-0">
                                <li class="contactHover pe-3" style="list-style-type:none;"><a
                                        style="text-decoration:none; color: rgb(0,0,0);" href="">FACEBOOK</a></li>
                                <div style="border:1px solid #ebebeb; height: 26px;"></div>
                                <li class=" contactHover ps-3" style="list-style-type:none; "><a
                                        style="text-decoration:none; color: rgb(0,0,0); " href=" ">TWITTER</a></li>
                            </ul>
                            <div class="row ">
                                <div class="col-md-5">
                                    <h2 class="mt-3" style="font-size:14px; font-weight: 600; color: #fc6e83; ">
                                        <span>PINK BEAUTY</span>
                                    </h2>
                                    <span>Pink Beauty đặc biệt phù hợp với các website mỹ phẩm - làm đẹp, thời trang -
                                        trang sức, thủ công mỹ nghệ - quà tặng.</span>
                                    <hr>
                                    <div>
                                        <div class="item ">
                                            <h6 class="mt-2 ">Hà Nội</h6>
                                            <div>
                                                <span><i class="fa-solid fa-location-dot "></i>118 Nguyen Khanh toan cau giay ha noi</span>
                                            </div>
                                            <div class="my-3 ">
                                                <span class="contactHover "><i class="fa-solid fa-phone "></i> <a
                                                        style="text-decoration:none; color: rgb(0,0,0); " href=" ">1900
                                                        6750</a></span>
                                            </div>
                                            <div>
                                                <span class="contactHover "><i class="fa-solid fa-envelope "></i> <a
                                                        style="text-decoration:none; color: rgb(0,0,0); "
                                                        href=" ">support@aptech.vn</a></span>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="item ">
                                            <h6 class="mt-2 ">TP HCM</h6>
                                            <div>
                                                <span><i class="fa-solid fa-location-dot "></i> ApTech, Tp Hồ Chí
                                                    Minh</span>
                                            </div>
                                            <div class="my-3 ">
                                                <span class="contactHover "><i class="fa-solid fa-phone "></i> <a
                                        ...
                                        <hr>
                                        <div class="item ">
                                            <h6 class="mt-2 ">Hải Phòng</h6>
                                            <div>
                                                <span><i class="fa-solid fa-location-dot "></i> ApTech, Hải Phòng</span>
                                            </div>
                                            <div class="my-3 ">
                                                <span class="contactHover "><i class="fa-solid fa-phone "></i> <a
                                                        style="text-decoration:none; color: rgb(0,0,0); " href=" ">1900
                                    ...
                                    <div class="login ">
                                        <h6 class="mt-4 ">GỬI TIN NHẮN CHO CHÚNG TÔI</h6>
                                        <form action="?controller=c_contactus" method="POST">
                                            <div class="row ">
                                                <div class="mb-4 ">
                                                    <input type="text " name="name" style="box-shadow:none; "
                                                        class="form-control rounded-0 " id="exampleFormControlInput1 "
                                                        placeholder="Họ tên* ">
                                                </div>
                                                <div class="mb-4 ">
                                                    <input type="text " name="email" style="box-shadow:none; "
                                                        class="form-control rounded-0 " id="exampleFormControlInput1 "
                                                        placeholder="Email* ">
                                                </div>
                                                <div class="mb-4 ">
                                                    <input type="email " name="phone" style="box-shadow:none; "
                                                        class="form-control rounded-0 " id="exampleFormControlInput1 "
                                                        placeholder="Số điện thoại* ">
                                                </div>
                                                <div>
                                                    <textarea style="box-shadow:none; " name="content"
                                            ...
                                            <div>
                                                <button name="btn_guilienhe" type="submit "
                                                    class="contactBtn btn-primary rounded-0 my-4 "
                                                    style="color:#fff; padding:10px 40px; font-size: 14px; background-color: #fc6e83; border: 0; ">Gửi
                                                    liên hệ</button>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="wrapcontact ">
                                        <div class="iFrameMap ">
                                            <div class="contact_map">
                                                <!-- <iframe
                                                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3723.9042716018666!2d105.815878!3d21.036516!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x87ab3917166a0cd5!2zUGjhuqduIG3hu4FtIHF14bqjbiBsw70gYsOhbiBow6BuZyAtIFNhcG8gUE9T!5e0!3m2!1svi!2sus!4v1654851659685!5m2!1svi!2sus"
                                                    width="100%" height="600" style="border:0;" allowfullscreen=""
                                                    loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
                                                <iframe
                                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2595.9549693906292!2d105.82101163727579!3d21.007302968827535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab7dbfbdcdbf%3A0x85d8837c4ab9ad4f!2zSGFub2ktQXB0ZWNoIFRyxrDhu51uZyDEkMOgbyBU4bqhbyBM4bqtcCBUcsOsbmggVmnDqm4gUXXhu5FjIFThur8!5e0!3m2!1svi!2s!4v1658825222329!5m2!1svi!2s"
                                                    width="100%" height="600" style="border:0;" allowfullscreen=""
                                                    loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                                        </div>
                                        ...
                                        <div class="footer-widget active">
                                            ...
                                            <div class="content">
                                                <ul class="list-menu list-showroom margin-top-10">
                                                    <li class="item">
                                                        <p><b>Hà Nội:</b> 118 Nguyen Khanh toan cau giay ha noi</p>
                                                    </li>
                                                    <li class="item">
                                            ...
                                            <div class="content">
                                                <div class="list-blogs list-image margin-top-25">
                                                    <div class="blog_in clearfix">
                                                        <a class="image image-blog"
                                                            href="/cong-dung-cua-dau-oliu-trong-lam-dep-khong-phai-ai-cung-biet"
                                                    ...
                                                    <div class="blog_in clearfix">
                                                        <a class="image image-blog"
                                                            href="/hoc-lom-bi-quyet-don-gian-giup-trang-da-muot-toc"
