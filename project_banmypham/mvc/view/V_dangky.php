                ...
                <form action="?controller=dangky" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-5 mt-5">
                            ...
                            <div class="mb-4">
                                <input type="email" name="email" style="box-shadow:none;"
                                    class="form-control rounded-0" id="exampleFormControlInput1"
                            ...
                            <div class="mb-4">
                                <input type="text" name="phone" style="box-shadow:none;"
                                    class="form-control rounded-0" id="exampleFormControlInput1"
                                    placeholder=" phone"
                            ...
                            <div class="mb-4">
                                <input type="text" name="address" style="box-shadow:none;"
                                    class="form-control rounded-0" id="exampleFormControlInput1"
                            ...
                            <div class="add-dn mb-4">
                                <button type="submit" class="login btn-primary rounded-0 w-100" name="btn_dangky"
                                    style="color:#fff; padding:10px 40px; font-size: 14px; background-color: rgb(252, 110, 131); border: 0;">ĐĂNG
                                    KÝ</button>
                                <p>Bạn đã có tài khoản? <a href="?controller=login">Đăng nhập tại đây</a></p>
                            </div>
                        </div>
                        <div class="col-md"></div>
                    </div>
